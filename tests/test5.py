...
class WebsiteUser41(FastHttpUser):
    wait_time = between(0.5, 1)
    @task
    def get_hospital_role50(self):
        self.client.get("/getHospitalRole50?userId=106aae55-15a5-5ff2-9210-c641d702b9ce&keychainrefId=92ca1d34-df07-511b-9ef3-c2ab785c1371")

class WebsiteUser42(FastHttpUser):
    wait_time = between(0.5, 1)
    @task
    def get_hospital_role50(self):
        self.client.get("/getHospitalRole50?userId=19b0b82b-e21b-5ce9-a981-df74489c97ad&keychainrefId=46daddb4-b45a-51db-9780-3602a3f826c5")

class WebsiteUser43(FastHttpUser):
    wait_time = between(0.5, 1)
    @task
    def get_hospital_role50(self):
        self.client.get("/getHospitalRole50?userId=a421bf15-35aa-521f-a03c-b9d33f1be6a7&keychainrefId=d5d40392-cc58-5ea8-bec3-37562d6ce54c")

class WebsiteUser44(FastHttpUser):
    wait_time = between(0.5, 1)
    @task
    def get_hospital_role50(self):
        self.client.get("/getHospitalRole50?userId=202a3176-4058-5062-9ce7-4bb7e52f33bb&keychainrefId=29905f0e-597e-5683-a494-6ad98d92c867")

class WebsiteUser45(FastHttpUser):
    wait_time = between(0.5, 1)
    @task
    def get_hospital_role50(self):
        self.client.get("/getHospitalRole50?userId=f48d193e-47df-55c0-8250-d6fd08d3977d&keychainrefId=7a5de012-3751-5a8b-b629-9b7c52e6f139")

class WebsiteUser46(FastHttpUser):
    wait_time = between(0.5, 1)
    @task
    def get_hospital_role50(self):
        self.client.get("/getHospitalRole50?userId=89940c12-9eef-5b3a-b829-024a8f11301b&keychainrefId=a48a11a8-fb64-5ff7-a112-8d471c8fe717")

class WebsiteUser47(FastHttpUser):
    wait_time = between(0.5, 1)
    @task
    def get_hospital_role50(self):
        self.client.get("/getHospitalRole50?userId=e8ea4416-c2bd-5258-a5b4-b32c6e726571&keychainrefId=21d9ec4b-2f30-5a64-a933-de419edaa685")

class WebsiteUser48(FastHttpUser):
    wait_time = between(0.5, 1)
    @task
    def get_hospital_role50(self):
        self.client.get("/getHospitalRole50?userId=2127c617-0b72-5745-8c24-8106aec155ce&keychainrefId=323e9f65-0648-57b1-b45b-0aaf4d915518")

class WebsiteUser49(FastHttpUser):
    wait_time = between(0.5, 1)
    @task
    def get_hospital_role50(self):
        self.client.get("/getHospitalRole50?userId=501647c4-80b9-5595-8917-8b4416abf035&keychainrefId=e804f4e4-c326-5c8a-82f4-61b9ba18dc00")

class WebsiteUser50(FastHttpUser):
    wait_time = between(0.5, 1)
    @task
    def get_hospital_role50(self):
        self.client.get("/getHospitalRole50?userId=4b0c092a-24c3-54ea-ba6b-b04fb9ad5c48&keychainrefId=bf71728a-a161-5808-ba69-d0dbf60f53fe")
...
user_classes = [
    ...
    WebsiteUser41, WebsiteUser42, WebsiteUser43, WebsiteUser44, WebsiteUser45,
    WebsiteUser46, WebsiteUser47, WebsiteUser48, WebsiteUser49, WebsiteUser50,
]
