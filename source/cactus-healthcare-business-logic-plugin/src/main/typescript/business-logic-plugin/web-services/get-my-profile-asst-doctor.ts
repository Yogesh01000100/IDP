...
export class GetMyProfileAssistantDoctor implements IWebServiceEndpoint {
  public static readonly CLASS_NAME = "GetMyProfileAssistantDoctor";
  private readonly log: Logger;
  private readonly keychainId: string;

  public get className(): string {
    return GetMyProfileAssistantDoctor.CLASS_NAME;
  }

  public getOasPath(): (typeof OAS.paths)["/api/cactus-healthcare-backend/get-my-profile-asst-doctor"] {
    return OAS.paths[
  ...
  async handleRequest(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      const request: RunTransactionRequest = {
        ...
        methodName: "GetMyProfileAssistantDoctor",
