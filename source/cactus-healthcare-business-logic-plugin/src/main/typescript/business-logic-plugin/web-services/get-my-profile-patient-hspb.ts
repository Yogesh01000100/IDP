...
export class GetMyProfilePatientB implements IWebServiceEndpoint {
  public static readonly CLASS_NAME = "GetMyProfilePatientB";
  private readonly log: Logger;
  private readonly keychainId: string;

  public get className(): string {
    return GetMyProfilePatientB.CLASS_NAME;
  }

  public getOasPath(): (typeof OAS.paths)["/api/cactus-healthcare-backend/get-my-profile-patient-hspb"] {
    return OAS.paths[
    ...
    try {
      this.log.debug(`${tag}`);
        ...
        signingCredential: {
          ...
          keychainRef: "1443fc3d-d5af-5e6d-931f-a40b4e81f2cc",
        },
