...
export class GetAppointmentData implements IWebServiceEndpoint {
  public static readonly CLASS_NAME = "GetAppointmentData";
  private readonly log: Logger;
  private readonly keychainId: string;

  public get className(): string {
    return GetAppointmentData.CLASS_NAME;
  }

  public getOasPath(): (typeof OAS.paths)["/api/cactus-healthcare-backend/get-appointment-data"] {
    return OAS.paths[
