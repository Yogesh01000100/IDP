...
export class GetEHRForDoctor implements IWebServiceEndpoint {
  public static readonly CLASS_NAME = "GetEHRForDoctor";
  private readonly log: Logger;
  private readonly keychainId: string;

  public get className(): string {
    return GetEHRForDoctor.CLASS_NAME;
  }

  public getOasPath(): (typeof OAS.paths)["/api/cactus-healthcare-backend/get-ehr-for-doctor"] {
    return OAS.paths[
