...
export class AcceptAppointment implements IWebServiceEndpoint {
  public static readonly CLASS_NAME = "AcceptAppointment";
  private readonly log: Logger;
  private readonly keychainId: string;

  public get className(): string {
    return AcceptAppointment.CLASS_NAME;
  }

  public getOasPath(): (typeof OAS.paths)["/api/cactus-healthcare-backend/accept-appointment"] {
    return OAS.paths[
