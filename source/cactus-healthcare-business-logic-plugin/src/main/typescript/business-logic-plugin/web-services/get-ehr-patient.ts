...
export class GetEHRForPatient implements IWebServiceEndpoint {
  public static readonly CLASS_NAME = "GetEHRForPatient";
  private readonly log: Logger;
  private readonly keychainId: string;

  public get className(): string {
    return GetEHRForPatient.CLASS_NAME;
  }

  public getOasPath(): (typeof OAS.paths)["/api/cactus-healthcare-backend/get-ehr-for-patient"] {
    return OAS.paths[
