...
export class CreatePatient implements IWebServiceEndpoint {
  public static readonly CLASS_NAME = "CreatePatient";
  private readonly log: Logger;
  private readonly keychainId: string;

  public get className(): string {
    return CreatePatient.CLASS_NAME;
  }

  public getOasPath(): (typeof OAS.paths)["/api/cactus-healthcare-backend/create-patient"] {
    return OAS.paths[
