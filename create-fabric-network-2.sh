...
cd ..
cd asset-transfer-basic/EHR
npm install
cd ../../test-network
export PATH=${PWD}/../bin:$PATH
export FABRIC_CFG_PATH=$PWD/../config/

peer lifecycle chaincode package basic.tar.gz --path ../asset-transfer-basic/EHR/ --lang node --label basic_1.0
...
CC_PACKAGE_ID=$(sed -n "/Package ID: basic_1.0/{s/^Package ID: basic_1.0://; s/, Label:.*$//; p;}" log.txt)
