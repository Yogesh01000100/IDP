...
export class CreateDoctor implements IWebServiceEndpoint {
  public static readonly CLASS_NAME = "CreateDoctor";
  private readonly log: Logger;
  private readonly keychainId: string;

  public get className(): string {
    return CreateDoctor.CLASS_NAME;
  }

  public getOasPath(): (typeof OAS.paths)["/api/cactus-healthcare-backend/create-doctor"] {
    return OAS.paths[
