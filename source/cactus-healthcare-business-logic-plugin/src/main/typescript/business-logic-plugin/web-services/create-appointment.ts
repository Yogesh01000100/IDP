...
export class CreateAppointment implements IWebServiceEndpoint {
  public static readonly CLASS_NAME = "CreateAppointment";
  private readonly log: Logger;
  private readonly keychainId: string;

  public get className(): string {
    return CreateAppointment.CLASS_NAME;
  }

  public getOasPath(): (typeof OAS.paths)["/api/cactus-healthcare-backend/create-appointment"] {
    return OAS.paths[
